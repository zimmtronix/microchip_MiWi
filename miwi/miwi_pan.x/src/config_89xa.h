...
#ifndef CONFIG_89XA_H
#define	CONFIG_89XA_H
   ...
   // #define RSSI_THRESHOLD  RSSI_THRESHOLD_79
    ...
    // acknowledgment packet in MiMAC layer after receiving a packet,
    // when such acknowledgment is requested by the packet sender.
    /*********************************************************************/
    #define ENABLE_ACK
    ...
    // acknowledgment packet is not received by the sender in predefined
    // time period.
    /*********************************************************************/
    //#define ENABLE_RETRANSMISSION
    // TODO:  RETRANSMISSION_TIMES is 3 but tries 15 times

    #define ENABLE_ACKENABLE_ACKENABLE_ACKENABLE_ACK
    ...
    // if a proper acknowledgment packet is not received in predefined
    ...
    //-65dB limit for CCA threshold values (as sampling at data/preamble)
    ...
    /*********************************************************************/
    // ACK_INFO_SIZE defines the number of acknowledgment information
